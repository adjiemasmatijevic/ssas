        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="card-body">
                    ...
                    <form action="<?= base_url('OPS/preview_ppkb') ?>" method="post" enctype="multipart/form-data" class="mt-4 container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="no_header" value="<?= isset($kategori['no_header']) ? $kategori['no_header'] : '' ?>">
                            </div>
                            <div class="col-md-4">
                        ...
                        <!-- SHIP PARTICULAR -->
                        <h5 class="mt-4 font-weight-bold border-bottom pb-2">SHIP PARTICULAR</h5>
                        <div class="row mt-3">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3"><label>Shipper/Consignee</label><input type="text" class="form-control" name="shipper"></div>
