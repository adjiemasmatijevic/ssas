            ...
            <div class="main-panel">
                <div class="container">
                    ...
                    <div class="form-container">
                        ...
                        <h5>SHIP BARGE PARTICULAR <span> (DATA KAPAL BARGE)</span></h5>
                        <hr style="border: none; height: 3px; background-color: black" />
                        ...
                        <div class="row particular-form mt-3">
                            ...
                            <div class="col-6 forms-part">
                                ...
                                <div class="data-item"><span>IMO/MMSI Numb:</span> <?= $ppkb['imo_mmsi'] ?></div>
                                <div class="data-item"><span>Call Sign:</span> <?= $ppkb['call_sign'] ?></div>
                                <div class="data-item"><span>Vsl Insurance Numb:</span> -</div>
                                <div class="data-item">
                                    <span>Owner/Charter:</span> <?= $ppkb['ship_owner'] ?> | <?= $ppkb['charter'] ?>
                                </div>
                                <div class="data-item"><span>Flag:</span> <?= $ppkb['flag'] ?></div>
                            ...
                            <!-- Kolom Kanan -->
                            <div class="col-6 forms-part">
                                <div class="data-item"><span>GT:</span> <?= $ppkb['gt'] ?> Ton</div>
                                <div class="data-item"><span>DWT:</span> <?= $ppkb['dwt'] ?> Ton</div>
                                <div class="data-item"><span>LOA:</span><?= $ppkb['loa'] ?> Meter</div>
                                <div class="data-item"><span>Breadth:</span><?= $ppkb['breadth'] ?> Meter</div>
                                <div class="data-item"><span>Air Draft:</span><?= $ppkb['air_draft'] ?> Meter</div>
                                <div class="data-item"><span>Max. Draft:</span><?= $ppkb['max_draft'] ?> Meter</div>
                                <div class="data-item"><span>Anchor Post:</span> <?= $ppkb['anchor_point'] ?> North/East</div>
                                <div class="data-item">
                        ...
                        <hr style="border: none; height: 3px; background-color: black" />
                        <h5>SHIP TUG PARTICULAR <span> (DATA KAPAL TUG)</span></h5>
                        <hr style="border: none; height: 3px; background-color: black" />
                        <div class="row particular-form mt-3">
                            <!-- Kolom Kiri -->
                            <div class="col-6 forms-part">
                                <div class="data-item"><span>Ship Name:</span> <?= $ppkb['ship_name2'] ?></div>
                                <div class="data-item"><span>IMO/MMSI Numb:</span> <?= $ppkb['imo_mmsi2'] ?></div>
                                <div class="data-item"><span>Call Sign:</span> <?= $ppkb['call_sign2'] ?></div>
                                <div class="data-item"><span>Vsl Insurance Numb:</span> -</div>
                                <div class="data-item">
                                    <span>Owner/Charter:</span> <?= $ppkb['ship_owner2'] ?> | <?= $ppkb['charter2'] ?>
                                </div>
                                <div class="data-item"><span>Flag:</span> <?= $ppkb['flag2'] ?></div>
                                <div class="data-item"><span>Master Name:</span> <?= $ppkb['master_name2'] ?></div>
                                <div class="data-item">
                                    <span>Route (Line/Tramp):</span> <?= $ppkb['route'] ?>
                                </div>
                                <div class="data-item"><span>Agent:</span> <?= $ppkb['agent_name'] ?></div>
                            ...
                            <!-- Kolom Kanan -->
                            <div class="col-6 forms-part">
                                <div class="data-item"><span>GT:</span> <?= $ppkb['gt2'] ?> Ton</div>
                                <div class="data-item"><span>DWT:</span> <?= $ppkb['dwt2'] ?> Ton</div>
                                <div class="data-item"><span>LOA:</span><?= $ppkb['loa2'] ?> Meter</div>
                                <div class="data-item"><span>Breadth:</span><?= $ppkb['breadth2'] ?> Meter</div>
                                <div class="data-item"><span>Air Draft:</span><?= $ppkb['air_draft2'] ?> Meter</div>
                                <div class="data-item"><span>Max. Draft:</span><?= $ppkb['max_draft2'] ?> Meter</div>
                                <div class="data-item"><span>Anchor Post:</span> <?= $ppkb['anchor_point2'] ?> North/East</div>
                                <div class="data-item">
                                    <span>Loading Point:</span> <?= $ppkb['loading_point'] ?> North/East
                                </div>
                            </div>
                        ...
                        <div class="geared">
                            <h4>&#10004; <?= $ppkb['geared'] ?></h4>
                            <div class="data-item">
                                <span>Numb of Crane / Grab (Jumlah Derek):</span> <?= $ppkb['qty_crane'] ?>
                            </div>
                        ...
                        <div class="ppkb_number mb-3">
                            <h3>
                                <?php
                                if ($ppkb['cargo_info'] == 'Unloading') {
                                    echo 'Cargo Unloading to Vessel';
                                } elseif ($ppkb['cargo_info'] == 'loading') {
                                    echo 'Cargo Loading to Vessel';
                                } else {
                                    echo $ppkb['cargo_info']; // Default kalau tidak sesuai
                                }
                                ?>
                            </h3>
                        ...
                        <div class="footer-section">
                            <div class="top-info">
                                ...
                                <div class="ship-agent">
                                    Ship Agent / Agen Kapal: <strong><?= $ppkb['nama_agen'] ?></strong>
                                </div>
                                <div class="date-info">
                        ...
                        <div class="d-flex gap-2 m-3 button-comb">
                            ...
                            <a href="<?= base_url('OPS/insert_ppkb2'); ?>"> <button class="btn btn-success">Simpan</button>
                            </a>
                        </div>
                    </div>
                </div>
